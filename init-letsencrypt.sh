...
domains=("arozgon.in.shpp.me")
email="rozgon1977@gmail.com" # Adding a valid address is strongly recommended
...
docker-compose up -d webserver && docker-compose restart webserver
