                        ...
                        <tr>
                            <td class="text-center">
                                <input type="text" class="form-control" id="name"
                                       name="name" required value="{{$people->name}}">
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="text" class="form-control" id="height"
                                       name="height" required value="{{$people->height}}">
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="text" class="form-control" id="mass"
                                       name="mass" required value="{{$people->mass}}">
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="text" class="form-control" id="hair_color"
                                       name="hair_color" value="{{$people->hair_color}}">
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="text" class="form-control" id="birth_year"
                                       name="birth_year" value="{{$people->birth_year}}">
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="date" class="form-control" id="created"
                                       name="created" value="{{$people->created}}">
                            </td>
                        </tr>
                    </table>
                </div>
                                    ...
                                    <select class="form-control" id="gender_id" name="gender_id" required>
                                        @foreach($genders as $gedersNext)
                                            <option value="{{$gedersNext->id}}"
                                                    @if($gedersNext->id == $people->gender_id) selected @endif>
                                                {{$gedersNext->gender}}
                                            </option>
                                        @endforeach
                                    </select>
                ...
                <div class="col-sm-4">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="form-group">
                                    <select class="form-control" id="homeworld_id" name="homeworld_id">
                                        @foreach($homeworlds as $homeworldsNext)
                                            <option value="{{$homeworldsNext->id}}"
                                                    @if($homeworldsNext->id == $people->homeworld_id) selected @endif>
                                                {{$homeworldsNext->name}}
                                            </option>
                                        @endforeach
                                    </select>
